...
009_jplayer:: Generate, deploy and run a simple application that plays music with jPlayer
010_kaminari:: Patch Kaminari and Install Kaminari on the EC2 server
011_jplayer_ublog:: Generate, deploy and run a simple application that plays music with jPlayer
012_monit:: Install Monit for monitoring, processes, files, directories and filesystems
