...
Select the new instance and get the Public DNS name. My DNS name is:
	...
	ec2-184-73-143-111.compute-1.amazonaws.com
...
Login to the new instance.
	...
	ssh -i server001keypair.pem ec2-user@ec2-184-73-143-111.compute-1.amazonaws.com
	sudo bash

This did not work.

	ssh -i server001keypair.pem root@ec2-184-73-143-111.compute-1.amazonaws.com
